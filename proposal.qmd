...
-   Identify the source of the data. **The source of this data is** **the Million Song Dataset**.
...
-   Write a brief description of the observations. **A brief description of the observations in this data set is that there are different songs associated by a song ID and their respective artists that also have an artist ID.**
