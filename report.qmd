...
We predict that rock and pop songs will have a strong positive relationship between tempo and popularity and that rap and country will still have a positive relationship, but not a strong one. We also predict that there will between year and popularity, since we expect more recent songs to be more popular. We do not predict the relationship between different song attributes and song popularity will differ for artists associated with different genres.
